...
class SZExampleAccessoryView: UIView, SZMentionsManagerProtocol {
    ...
    init(frame: CGRect, delegate: UITextViewDelegate) {
        ...
        let mentionsListener = SZMentionsListener(mentionTextView: textView,
                                                  mentionsManager: self, textViewDelegate: delegate, mentionTextAttributes: mentionAttributes(), defaultTextAttributes: defaultAttributes(),spaceAfterMention: true, addMentionOnReturnKey: true, searchSpaces: true)
